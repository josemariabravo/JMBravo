---
aliases:
  - /posts/planificacion-literaria-metodo-snowflake-novela/
...
revisado: true
---
En anteriores entradas de esta bitácora he tanteado el arduo asunto de la creación de una novela. Hasta ahora solo he reflexionado sobre los dos métodos clásicos ([mapa o brújula](/blog/mapa-o-brujula/) y sobre cómo [organizar la información de una historia](/blog/sobre-la-organizacion-de-una-novela-planificacion-literaria-ii/).
...
Por otra parte, es perfectamente compatible con el método de organización que [propuse en esta entrada](/blog/sobre-la-organizacion-de-una-novela-planificacion-literaria-ii/). (Los documentos de planificación que resulta de este método entrarían en la categoría ARG.)
...
(3) Y por último: no soy traductor profesional ni intento serlo. Esta traducción dista mucho de ser literal; podéis comprobar la versión original del artículo [en la página web del autor](http://www.advancedfictionwriting.com/art/snowflake.php). En cualquier caso, modestia aparte, creo que la traducción que he hecho es aceptable y traslada lo esencial del método sin omitir nada crucial. Si creéis que he omitido algo importante o que he cometido algún error de bulto, no dudéis en comentarlo.
...
Durante varios años fui programador de *software* y participé en proyectos de cierta envergadura. Escribo novelas de la misma forma que programo *software*, usando la metáfora del copo de nieve. ¿De qué se trata? Antes de continuar, échale un ojo a esta página: [Copo de Koch](http://math.rice.edu/~lanius/frac/koch/koch.html)
...
(Nota: es un [copo de nieve de Koch](http://es.wikipedia.org/wiki/Copo_de_nieve_de_Koch), que debe su nombre al matemático sueco Helge von Koch.)
...
(Nota: Personalmente prefiero la [estructura clásica de tres actos](http://es.wikipedia.org/wiki/Trama_\(narratología\))).
...
(Nota: Ya vimos algo similar anteriormente en [Planificación literaria, ii](/blog/sobre-la-organizacion-de-una-novela-planificacion-literaria-ii/), en el que di unas pocas directrices sobre cómo afrontar lo que llamé «esbozo».)
...
(Nota: realmente es fácil aprender lo básico de una hoja de cálculo, como Calc de [OpenOffice](http://es.openoffice.org/), para estos fines.)
...
(Nota: el autor desarrolló un programa que automatiza el proceso. Podéis conseguir detalles en esta [página de su web](http://www.advancedfictionwriting.com/info/snowflake_pro/index.php). No lo he probado, por si os lo estáis preguntando, ni lo promociono ni nada parecido.)

Si el método del copo de nieve te ha servido, me gustaría conocer tu experiencia al respecto. Puedes contactar conmigo a través de la página de [contacto de mi sito web](http://www.advancedfictionwriting.com/home/contact.php).
