...
En el proceso creativo, el autor crea una obra a partir de la idea de la misma que tiene en su cabeza, suerte de mapa mental de un laberinto que solo él puede recorrer. El resultado es una proyección de esa idea. No la idea. Así, *H*, la idea, es mayor que la obra (*h*): y eso es bueno, porque con la omisión de información se consigue reforzar el mensaje de la misma. Les remito al citado principio del iceberg. El de las ocho partes debajo y una en la superficie. O el excelente adagio que tomo prestado a León Arsenal: *[lo que no suma, resta](http://www.leonarsenal.com/bitacora/?p=292).*
